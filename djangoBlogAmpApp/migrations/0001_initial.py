# Generated by Django 4.0.7 on 2022-11-11 07:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='djangoBlogAmpApp.post')),
            ],
            options={
                'ordering': ['created_on'],
            },
